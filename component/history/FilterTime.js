...
const FilterTime = () => {
  return (
    <View
      style={tw`absolute bg-mgray z-50 w-full h-14 rounded-t-2xl border-t-2 border-l bottom-0 border-r border-gray-300 flex-row items-center px-4 flex-row items-center justify-between`}
    >
      <View style={tw`px-2`}>
        <FilterDropdown />
      </View>
