...
import { OpenOrderStatus, CloseOrderStatus, CloseOutletStatus  } from "../../lib/listSvg"
...
const Status = () => {
  const [checked, setChecked] = React.useState('a');
    return (
      <ScrollView showsVerticalScrollIndicator={false} horizontal={false} centerContent={true}>      
          <View style={tw`bg-white w-full h-auto py-4 flex-row`}>
           ...
           <OpenOrderStatus/>
            ...
            Status dimana kamu bisa menerima orderan, dan menyelesaikan transaksi dengan pelanggan kamu.
            </Text>
           </View>
          </View>
          <View style={tw`bg-white w-full h-auto py-4 flex-row`}>
           ...
           <CloseOrderStatus/>
         <Text style={tw`text-gray-800 text-base font-semibold mt-2 mr-10`}>
            Status dimana kamu sudah nggak nerima lagi orderan, tapi bisa  menyelesaikan transaksi dengan pelanggan kamu.
            </Text>
           </View>
          </View>
          <View style={tw`bg-white w-full h-auto py-4 flex-row`}>
