...
const cards = [
  {
    ...
    judul: "Upacara Bendera Merah Putih",
    img: "https://pltuinjakarta.files.wordpress.com/2011/08/bendera-merah.jpg",
  },
  {
    name: "Card 2",
    key: 2,
    deskripsi:
      "Setiap tanggal 21 April kita bangsa Indonesia memperingati Hari Kartini. Mengapa sih hari Kartini selalu diperingati setiap tahunnya? Siapa Kartini, dan apa jasanya bagi bangsa dan negara kita? Untuk lebih jelasnya kita baca yuk artikel ini sampai tuntas",
    judul: "Selamat Hari Kartini, Ketahui Semua Tentang Kartini!",
    img: "https://cashbac.com/blog/wp-content/uploads/2020/04/hari-kartini-759x500.jpg",
  },
  {
    name: "Card 3",
    key: 3,
...
const renderItem = ({ item, index }, handleExpandPresss) => (
  <View
    style={[
      tw`w-[8.3rem] h-[15rem] bg-white rounded overflow-hidden ${
  ...
  >
    <TouchableOpacity onPress={handleExpandPresss}>
      ...
      <View style={[tw`h-[3rem] p-1`, {}]}>
        <Text
          style={[tw`text-sm font-semibold text-gray-400`]}
          numberOfLines={2}
        >
          {item.judul}
        </Text>
      ...
      <View style={[tw`h-full p-1`]}>
        <Text style={[tw`text-xs font-normal text-gray-700`]} numberOfLines={3}>
          {item.deskripsi}
        </Text>
      </View>
    </TouchableOpacity>
...
const Pengumuman = React.memo(({ handleExpandPresss }) => {
  return (
    ...
    >
      ...
      >
        <View
          style={tw`w-full h-auto flex flex-col items-center justify-center`}
        >
          <Image
