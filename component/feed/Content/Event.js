  ...
  const feed = [
    {
      ...
      user_pic:
        "https://cdn.discordapp.com/attachments/957998627928817684/993405757213134938/redwhite.png",
      ...
      {feed.map((f, i) => {
        return (
          ...
          >
            ...
            <View
              style={tw`border border-gray-300 p-3 rounded-xl mb-4 bg-white shadow-sm`}
            >
