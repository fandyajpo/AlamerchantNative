...
const UserCard = React.memo(() => {
  ...
  return (
    ...
    >
      ...
      {/*Bulet bulet*/}
      {/*Card*/}
      <View style={tw`w-full h-auto absolute bottom-3 bg-transparent px-4 flex flex-col`}>
        ...
        {useMemo(() => {
          return (
            ...
            >
              ...
              <View style={tw`w-18 h-18 mr-3 flex-none bg-transparent justify-center overflow-hidden rounded-lg`}>
                <Image
                  style={{
                    flex: 1,
                    width: '100%',
              ...
              <View style={tw`w-auto h-full flex flex-col bg-transparent`}>
                <View style={tw`w-full h-12 bg-transparent flex justify-center`}>
                  <Text style={tw`text-base font-bold text-white capitalize`}>
                    {state?.profile?.nama_lengkap ? state.profile.nama_lengkap : "-"}
                  </Text>
                  <Text style={tw`text-xs font-bold text-white`}>
                    {state?.profile?.kelas ? state?.profile?.kelas+` - `+state?.profile?.jurusan : "-"}
                  </Text>
                </View>
                <View style={tw`w-full h-9 bg-transparent flex flex-row`}>
                  ...
                  >
                    ...
                    <Text style={tw`text-gray-500 font-bold text-base px-2`}>Clock In</Text>
                  </Pressable>
                  <View style={tw`w-2`} />
                  <Pressable
                    // onPress={() => hapus()}
                  ...
                  >
                    {/*<MaterialCommunityIcons name="face-recognition" size={16} color="black" />*/}
                    <Text style={tw`text-gray-500 font-bold text-base px-2`}>Clock Out</Text>
                  </Pressable>
                </View>
              </View>
...
const PresensiCard = React.memo(() => {
  ...
  return (
    <View style={tw`w-full px-3 py-3`}>
      ...
      >
        <View style={tw`w-full rounded-md py-2.5 px-3 flex flex-row items-center justify-between bg-transparent`}>
          <View style={tw`bg-gray-100/70 border border-gray-200 p-2 w-3/5 h-full rounded-md`}>
          ...
          <View
            style={tw`w-24 h-24 flex items-center justify-center`}
          >
...
const renderItem = ({ item, index }) => (
 <View style={tw`w-42 h-64 bg-white rounded ${index+1 < cards.length ? ( index < 1 ? 'ml-26 mr-4' : 'mr-4') : ''}`}>
    <Text style={tw`text-red-900`}>{item.name} {index}</Text>
 </View>
);
